                                        ...
                                        <div class="carousel-item active">
                                            <div class="position-relative">
                                                <?php if($statusProduto == 'esgotado'): ?>
                                                    <div class="position-absolute top-50 start-50 translate-middle bg-danger text-white px-4 py-2 fs-5 fw-bold rounded shadow" style="z-index: 10; opacity: 0.85;">
                                                        ESGOTADO
                                                    </div>
                                                <?php endif; ?>
                                                <img src="<?php echo $fotoProduto ?>" alt="Nome do Produto" class="d-block w-100" style="<?php echo $statusProduto == 'esgotado' ? 'filter:grayscale(100%)' : ''; ?>">
                                            </div>
                                        </div>
                                                ...
                                                if(isset($_SESSION['logado']) && $_SESSION['logado'] === true){ //Verifica de há sessão iniciada
                                                    ...
                                                    echo "
                                                        <div class='alert alert-info'>
                                                            <a href='formLogin.php' class='alert-link'><i class='bi bi-person' style='font-size:16pt;'></i> <strong>Acesse o sistema</strong></a> para comprar!
                                                        </div>
                                                    ";
                                                }
                                            ?>
